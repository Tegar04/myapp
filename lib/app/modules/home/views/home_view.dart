    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Store Address', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Text('Jl. Kpg Sutoyo'),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Hotcig R234', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  Text('VAPEBOSS'),
                ],
              ),
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text('Price'),
                Obx(() => Text('\$${controller.price.value.toStringAsFixed(2)}')),
              ],
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            Row(
              ...
              children: [
                ...
                Obx(() => Text('\$${controller.total.value.toStringAsFixed(2)}', style: TextStyle(fontWeight: FontWeight.bold))),
              ],
            ),
          ],
        ),
